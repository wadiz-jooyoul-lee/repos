...
| Repo | 역할 | 스택 |
|---|---|---|
| [com.wadiz.web](./docs/com.wadiz.web/) | www.wadiz.kr 본체 (레거시 FE+BE) — `wadiz-frontend`로 점진 이관 중 — **심층 분석 (8파일, 447 JSP / 309 controller / 264 mapper XML)** | Spring 3.2 / Java 8 / WAR |
